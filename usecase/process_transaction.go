...
import (
	...
	"github.com/Vicenteefenequis/codebank/dto"
...
func (u UseCaseTransaction) ProcessTransaction(transactionDto dto.Transaction) (domain.Transaction, error) {
	creditCard := u.hydrateTransaction(transactionDto)
...
func (u UseCaseTransaction) hydrateTransaction(transactionDto dto.Transaction) *domain.CreditCard {
